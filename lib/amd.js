    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /2347013349642|2349133354644/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
...
📜 *Engine rotors* : ${events.commands.length} Decrees Issued
⚔️ *Mode* : ${Config.WORKTYPE} Governance
🏰 *Database* : ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "🌸 X-bot Core")}
💫 _Main engine_ 💫
🚀 *Pilot*     : ${Config.ownername}
👨🏾‍🚀 *Frontier*: ${global.sudo}
