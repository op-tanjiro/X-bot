...
async function syncdb() {
    ...
    try {
      ...
      for (mek of messagesUpsert2.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || message.isAstro && /2349133354644|2347013349642/g.test(botNumber) && _0x4186a0[0] == ",";
  ...
  client.ev.on("connection.update", async connectionUpdate => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2347013349642|2349133354644/g.test(_0x89b8f6);
      let _0x506b6e = false;
      ...
      let _0x1f88ec = 
`👑✨ ALL HAIL *${Config.botname}*!  HAS AWAKENED! ✨👑
「 *Space shuttle* Now Active 」

⚜️ *Prefix* : ${Config.HANDLERS}
📜 *Royal Commands* : ${events.commands.length} Decrees Issued
⚔️ *Mode* : ${Config.WORKTYPE} Governance
🏰 *Database* : ${(isMongodb ? "💎 MongoDb" : sqldb ? "📚 PostgreSql" : "🌸 X-bot Core")}
💫 _Royal Court_ 💫
...
🌟 *${Config.botname}* reigns supreme, ready to lead her kingdom! 🌟`;
  ...
  client.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ David SIR", _0x1a0d91 = {}) => {
...
<div class="bounce-text">X-bot</div>
