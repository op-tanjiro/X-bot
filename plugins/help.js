...
smd({ 'on': 'text' }, async (message, reply, { mek, body, args, botNumber, isCreator, icmd, store, budy, Xbot, Void, proto }) => {
  try {
      ...
      if (categoryName.length > 0 && categoryName.length < 20) {
        ...
        for (const category in commandsList) {
          if (categoryName.includes(category.toLowerCase())) {
            categoryMenu = `┏━━━━━━━━━━━━━━━━━━━━━━━\n┃ *X-BOT_${category.toUpperCase()}_COMMANDS* \n┗━━━━━━━━━━━━━━━━━━━━━━━\n\n`;
