...
smd(
  ...
  try {
    ...
    let { data: repoData } = await axios.get("https://api.github.com/repos/Mek-d1/X-bot");
    
    let responseMessage = (`
X-bot, ᴀ sɪᴍᴘʟᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ, ᴍᴀᴅᴇ ʙʏ Mek-d1 ᴀɴᴅ ᴅᴇᴘʟᴏʏᴇᴅ ʙʏ *Mek-d1*.
  ...
  *❲❒❳ Repo:* _https://github.com/Mek-d1/X-bot_
