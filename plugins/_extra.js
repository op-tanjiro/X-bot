...
smd({
  cmdname: "feature",
  alias: ["totalfeature", "features", "X-bot"],
  category: "tools",
  filename: __filename,
  ...
  try {
    ...
    try {
      let {
        key: _0x2d7cf6
      } = await _0x4e7c63.send("Counting... 0", {}, "-X-:bot", _0x4e7c63);
...
smd({
  ...
  try {
    ...
    await _0x4cdec8.error(_0x126b07 + "\n\ncommand : ss", _0x126b07, "*Request Denied!*");
  }
});
