...
smd({
  ...
  try {
    ...
    // Use the new API to get download links
    const downloadApiUrl = "https://bk9.fun/download/youtube2?url=" + encodeURIComponent(_0x4f86cb.url);
    ...
    while (_0x4acf6c > 0) {
      try {
        ...
        if (_0x509920.status && _0x509920.BK9.BK9) {
          const _0x539170 = _0x509920.BK9.BK9;
